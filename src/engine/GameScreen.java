...
public abstract class GameScreen {
	...
	final public void setParentGame(MainGame mg) { game = mg; }
	
	//Returns the screen index
	final public int getScreenIndex() { return screenIndex; }
	
	final public ScreenState getScreenState() { return state; }
	
	final public void setRunning() { state = ScreenState.RUNNING; }
	
	//Return the next and previous screen indices, this will be dependent on the game hence they are abstract
